...
export default function ZainPaymentPortal() {
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center gap-1 sm:gap-2">
            <button className="p-2 sm:p-3 hover:bg-muted rounded-xl transition-colors duration-200">
              <User className="w-4 h-4 sm:w-5 sm:h-5 text-[#00a651]" />
            </button>
            <button className="p-2 sm:p-3 hover:bg-muted rounded-xl transition-colors duration-200">
          ...
          <div className="flex items-center">
            <span className="text-2xl sm:text-3xl font-bold text-[#00a651] tracking-tight">
              zain
            </span>
          </div>
          ...
          <button className="p-2 sm:p-3 hover:bg-muted rounded-xl transition-colors duration-200">
            <div className="flex flex-col gap-1 sm:gap-1.5">
              <div className="w-5 sm:w-6 h-0.5 bg-[#00a651] rounded-full"></div>
              <div className="w-5 sm:w-6 h-0.5 bg-[#00a651] rounded-full"></div>
              <div className="w-5 sm:w-6 h-0.5 bg-[#00a651] rounded-full"></div>
            </div>
          </button>
        ...
        <div className="max-w-sm sm:max-w-md mx-auto">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex gap-3 sm:gap-4">
                <Button
                  variant="outline"
                  size="lg"
                  className="flex-shrink-0 h-10 w-12 sm:h-10 sm:w-14 border-2 border-[#00a651] text-[#00a651] hover:bg-[#00a651] hover:text-white bg-transparent rounded-xl transition-all duration-200"
                >
                ...
                <Button
                  ...
                  disabled={isLoading}
                  className="flex-1 h-10 sm:h-10 bg-[#00a651] hover:bg-[#00a651]/90 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200  disabled:opacity-50"
                >
          ...
          <div className="max-w-xs sm:max-w-md mx-auto">
            <div className="bg-muted/50 rounded-2xl p-4 sm:p-6 text-center">
              <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 bg-[#00a651]/10 rounded-2xl flex items-center justify-center">
                <Smartphone className="w-6 h-6 sm:w-8 sm:h-8 text-[#00a651]" />
              </div>
              <h3 className="text-base sm:text-lg font-bold text-foreground mb-2 sm:mb-3">أعد تعبئة خطك</h3>
              <p className="text-xs sm:text-sm text-muted-foreground mb-4 sm:mb-6 leading-relaxed">
                أعد تعبئة خطك للمكالمات أو خط الإنترنت بخطوات بسيطة واستمتع بتجربة سهلة للدفع المسبق مع zain.
              </p>
              <Button className="w-full h-10 sm:h-12 bg-[#00a651] hover:bg-[#00a651]/90 text-white font-semibold rounded-xl">
                تعبئة رصيد الآن
              </Button>
            </div>
          </div>
          ...
          <div className="max-w-xs sm:max-w-md mx-auto">
            <div className="bg-muted/50 rounded-2xl p-4 sm:p-6 text-center">
              <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 bg-[#00a651]/10 rounded-2xl flex items-center justify-center">
                <Shield className="w-6 h-6 sm:w-8 sm:h-8  text-[#00a651]" />
              </div>
        ...
        <div className="px-3 sm:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12 text-right">
              ...
              <div>
                <h4 className="font-semibold mb-3 sm:mb-4 text-sm sm:text-base">عن zain</h4>
                <ul className="space-y-2 text-xs sm:text-sm opacity-90">
                  <li>
                    <a href="#" className="hover:opacity-100 transition-opacity">
                      من نحن
            ...
            <div className="text-center border-t border-white/20 pt-6 sm:pt-8">
              ...
              <p className="text-xs sm:text-sm opacity-75">جميع الحقوق محفوظة © 2025 شركة زين للاتصالات</p>
            </div>
          </div>
        </div>
      </footer>
